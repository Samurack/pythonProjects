...
# root = Tk()
# MyLeftPos = (root.winfo_screenwidth() - 500) / 2 #https://www.skotechlearn.com/2020/06/tkinter-window-position-size-center-screen-in-python.html --- Process(3):
# myTopPos = (root.winfo_screenheight() - 500) / 2

# lbl_label = Label( #https://www.instructables.com/Create-a-Simple-Python-Text-Editor/
#     text="All Template Issues",
...
# root.geometry( "%dx%d+%d+%d" % (500, 500, MyLeftPos, myTopPos))
