import math
# These constants define the size of the game window
WIDTH = 800
...
easy_lair = {
	"dragon": Actor("dragon-asleep", pos=(600, 100)), #Coordinates for dragon in his lair
	"eggs": Actor("one-egg", pos=(400, 100)), 		  #Sets coordinates of eggs
	"egg_count": 1,								  	  #Number of eggs in lair
	"egg_hidden": False,							  #Checks if eggs are currently hidden
	"egg_hide_counter": 0,							  #How many seconds the eggs have been hidden for
	"sleep_length": 10,								  #Tracks dragon sleep cycle
	"sleep_counter": 0,								  #Tracks dragon sleep cycle
	"wake_counter": 0								  #Tracks dragon sleep cycle
}
